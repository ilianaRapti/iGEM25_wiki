...
const teamMembers: Member[] = [
...

  {
    ...
    role: 'Co-head of Human Practices, Wet Lab Member',
 ...
 
  {
    id: 4,
    name: 'Thomas Katikos',
    role: 'Co-head of Wet Lab and Member of Fundraising',
    description: 'Thomas is an undergraduate student in the Department of Biological Applications and Technology of University of Ioannina. Thomas is a wet lab co-head and a fundraising member, he plays a vital role in advancing the project both inside the lab and through community engagement. He sets a high standard for lab work and inspires those around him to do their best.',
...

  {
    id: 7,
    name: 'Iliana Rapti',
    role: 'Member of Dry Lab, Graphics',
  ...
  {
    id: 12,
    name: 'Mairi Peristeri',
    role: 'Member of Wet Lab',
    description: 'Mairi is an undergraduate student in the Department of Medicine of University of Ioannina. Mairi is a wet lab member. She brings a unique medical perspective to the wet lab, combining her academic background in medicine. Her curiosity truly enriches the team.',
